    ...
    Pausable
{
    ...
    function flashFee(
        ...
        console.log("Flash fee calculation:");
        console.log("Requested flash loan amount:", _amount);
        console.log("Max flash loan amount:", maxFlashLoan(_token));
    ...
    function flashLoan(
        ...
        console.log("Vault total assests before flash loan:", balanceBefore);
        console.log(
            "Convert to Shares for total supply:",
        ...
        console.log("Calculated flash fee: ", fee);
        if (
